...
namespace Microsoft.AspNetCore.Mvc.RazorPages
{
    public class PageSaveTempDataPropertyFilterFactoryTest
    {
        ...
        {
            // Arrange
            var properties = LifecycleProperty.GetLifecycleProperties(typeof(TestPageModel), typeof(TempDataAttribute), "");
            var factory = new PageSaveTempDataPropertyFilterFactory(properties);
            ...
            Assert.Same(properties, pageFilter.Properties);
        }
